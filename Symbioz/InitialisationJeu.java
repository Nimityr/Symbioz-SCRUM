...
public class InitialisationJeu
{
	...
	public InitialisationJeu()
	{
		...
		sc.nextLine();
			...
			plateau[0] = new Case(this.nbrJoueurs);
			plateau[1] = new Case(this.nbrJoueurs);
			plateau[2] = new Case(this.nbrJoueurs);
			plateau[3] = new Case(this.nbrJoueurs);
      
			plateau[4] = new Case(this.nbrJoueurs);
			plateau[5] = new Case(this.nbrJoueurs);
			plateau[6] = new Case(this.nbrJoueurs);
			plateau[7] = new Case(this.nbrJoueurs);
			plateau[8] = new Case(this.nbrJoueurs);
			plateau[9] = new Case(this.nbrJoueurs);
			plateau[10] = new Case(this.nbrJoueurs);
			plateau[11] = new Case(this.nbrJoueurs);
      
			plateau[12] = new Case(this.nbrJoueurs);
			plateau[13] = new Case(this.nbrJoueurs);
			plateau[14] = new Case(this.nbrJoueurs);
			plateau[15] = new Case(this.nbrJoueurs);
			plateau[16] = new Case(this.nbrJoueurs);
			plateau[17] = new Case(this.nbrJoueurs);
			plateau[18] = new Case(this.nbrJoueurs);
			plateau[19] = new Case(this.nbrJoueurs);
			plateau[20] = new Case(this.nbrJoueurs);
			plateau[21] = new Case(this.nbrJoueurs);
			plateau[22] = new Case(this.nbrJoueurs);
			plateau[23] = new Case(this.nbrJoueurs);
